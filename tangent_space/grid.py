...
def create_grid(map, width, height, coord):
    ...
    for disp in range(-normed_max,normed_max,1):
        ...
        if disp == 0:
            vertical_lines.append((vert_line_bottom, vert_line_top, LINE_WIDTH + 1))
        else:
            vertical_lines.append((vert_line_bottom, vert_line_top, LINE_WIDTH))
    ...
    for disp in range(-normed_max,normed_max,1):
        ...
        if disp == 0:
            horizontal_lines.append((hor_line_left, hor_line_right, LINE_WIDTH + 1))
        else:
            horizontal_lines.append((hor_line_left, hor_line_right, LINE_WIDTH))
