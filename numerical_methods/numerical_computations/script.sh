if [ "$#" -lt 2 ]; then
	...
	if [[ "$OSTYPE" == "darwin"* ]]; then
		...
		gcc -Wall -Wextra -D CL_TARGET_OPENCL_VERSION=100 temp.c -o HelloOpenCL -lOpenCL			gcc -Wall -Wextra -D CL_TARGET_OPENCL_VERSION=100 temp.c -o HelloOpenCL -lOpenCL
